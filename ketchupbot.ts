...
var SHIP_NAME_MAP: any = {
	2018: "2018 Ship",
	yname: "Yname (ship)"
}

// Exempt certain parameters from the final result.
export var parameters_to_exempt: string[] = [
	"damage_res"
]
...
export class ShipUpdater {
	...
	async main(bot: any, logChange: Function, logDiscord: Function, manual: Boolean) {
...
// When running this file directly, run the init function.
